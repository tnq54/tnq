...
def parse_args():
    ...
    parser.add_argument("--lora_r", type=int, default=16, help="LoRA rank (Network Dim)")
    parser.add_argument("--lora_alpha", type=int, default=32, help="LoRA alpha scaling factor")
    parser.add_argument("--conv_dim", type=int, default=16, help="Conv LoRA rank dimension")
    parser.add_argument("--conv_alpha", type=int, default=16, help="Conv LoRA alpha scaling factor")
    ...
    parser.add_argument("--learning_rate", type=float, default=2e-4, help="Overall Learning rate")
    parser.add_argument("--unet_lr", type=float, default=None, help="Specific UNet Learning rate")
    parser.add_argument("--text_encoder_lr", type=float, default=None, help="Specific Text Encoder Learning rate")
    parser.add_argument("--warmup_ratio", type=float, default=0.03, help="Warmup ratio")
    parser.add_argument("--min_snr_gamma", type=float, default=0.0, help="Min SNR Gamma for loss weighting")
    ...
    parser.add_argument("--num_epochs", "--num_train_epochs", type=int, default=1, help="Number of training epochs")
    parser.add_argument("--per_device_train_batch_size", "--train_batch_size", type=int, default=2, help="Batch size per device")
    parser.add_argument("--save_every_n_epochs", type=int, default=1, help="Save checkpoint every N epochs")
    parser.add_argument("--caption_extension", type=str, default=".txt", help="Caption extension for datasets")
    ...
    parser.add_argument("--config_save_dir", type=str, default="./configs", help="Directory to save exported training configurations")
